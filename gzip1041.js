...
function convc(val,de,para){re=0;switch(de){case'metro':switch(para){case'metro':re=val;break;case'polegada':re=val*39.37007874015748;break;case'milha':re=val*0.0006213711922373339;break;case'jarda':re=val*1.0936132983377078;break;}
break;case'polegada':switch(para){case'metro':re=val*0.0254;break;case'polegada':re=val;break;case'milha':re=val*0.00001578282828282828;break;case'jarda':re=val*0.027777777777777776;break;}
break;case'milha':switch(para){case'metro':re=val*1609.344;break;case'polegada':re=val*63360;break;case'milha':re=val;break;case'jarda':re=val*1760;break;}
break;case'jarda':switch(para){case'metro':re=val*0.9144;break;case'polegada':re=val*36;break;case'milha':re=val*0.8503401360544218;break;case'jarda':re=val;break;}
break;}
return re;}
